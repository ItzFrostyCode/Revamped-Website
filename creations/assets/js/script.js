document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateToggleButtons(currentTheme, animate = true) {
    ...
    function applyThemeWithTransition(theme) {
        ...
        setTimeout(() => {
            ...
            updateToggleButtons(theme, true);
    ...
    body.classList.remove('light-mode', 'dark-mode'); // Clear any existing theme classes
    body.classList.add(preferredTheme); // Apply the preferred theme
    updateToggleButtons(preferredTheme, false);
